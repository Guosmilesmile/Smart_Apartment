...
<%-- <%} %> --%>
   ...
   <%--  <%}else{}%>
    ...
    <ul class="menuson">
        <li><cite></cite><a href="filltablepower.jsp" target="rightFrame">填报权限</a><i></i></li>
  ...
  <%--   <%} %>
    ...
    <ul class="menuson">
        <li><cite></cite><a href="<%=basePath %>showTest/newsChartTest.jsp" target="rightFrame">新闻统计展示</a><i></i></li>
    </ul>
    </dd>  
    </dl>
