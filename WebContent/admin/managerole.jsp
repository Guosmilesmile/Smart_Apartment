...
<body>
    ...
    <div class="pagin">
    	<div class="message">共<i class="blue" id='blue'>  </i>个纪录</div>
         <ul class="paginList">
        <li class="paginItem"><a id='firstpage' href="javascirp:;" >首页</a></li>
        <li class="paginItem"><a id='prepage' href="javascirp:;">上页</a></li>
        <li class="paginItem"><a id='nextpage' href="javascirp:;">下页</a></li>
        <li class="paginItem"><a id='lastpage' href="javascirp:;" >末页</a></li>
        </ul> 
    </div>
